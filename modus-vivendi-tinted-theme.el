...
;;; Common accent foregrounds
      ...
      (green-cooler    "#A3E635")
      (green-faint     "#4D7C0F")
      (green-intense   "#3F6212")
      (yellow          "#CA8A04")
      (yellow-warmer   "#EAB308")
      (yellow-cooler   "#FACC15")
      (yellow-faint    "#A16207")
      (yellow-intense  "#854D0E")
      (blue            "#0284c7")
      (blue-warmer     "#0ea5e9")
      (blue-cooler     "#38BDF8")
      (blue-faint      "#0369a1")
      (blue-intense    "#075985")
      (magenta         "#db2777")
      (magenta-warmer  "#ec4899")
      (magenta-cooler  "#f472b6")
      (magenta-faint   "#be185d")
      (magenta-intense "#9d174d")
      (cyan            "#0891b2")
      (cyan-warmer     "#06b6d4")
      (cyan-cooler     "#22d3ee")
      (cyan-faint      "#0e7490")
