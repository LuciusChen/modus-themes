...
;;;;; corfu
    ...
    `(corfu-bar ((,c :inherit modus-themes-fixed-pitch :background ,fg-dim)))
...
;;;;; doom-modeline
    ...
    `(doom-modeline-evil-insert-state ((,c :foreground ,rust)))
    `(doom-modeline-evil-motion-state ((,c :foreground ,indigo)))
    `(doom-modeline-evil-normal-state ((,c :foreground ,olive )))
    `(doom-modeline-evil-operator-state ((,c :foreground ,slate)))
    `(doom-modeline-evil-replace-state ((,c :inherit error)))
    `(doom-modeline-evil-visual-state ((,c :foreground ,pink)))
...
;;;;; vterm
    ...
    `(vterm-color-black ((,c :background ,bg-term-black-bright :foreground ,fg-term-black-bright)))
...
;;;;; whitespace-mode
    ...
    `(whitespace-space-after-tab ((,c :inherit background ,bg-space)))
    `(whitespace-space-before-tab ((,c :inherit background ,bg-space)))
